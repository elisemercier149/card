...
function removeAllFrameClasses() {
    ...
    var er = ["", "webkit", "Moz", "MS", "ms", "o"],
        ...
        d = Math.abs,
        hi = Date.now,
        y, li, sr, ar, ru, uu, fu, bi, vu, ur, pu;
    y = typeof Object.assign != "function" ? function(n) {
        var f, i, t, u;
    ...
    o(ii, s, {
        handler: function(n) {
            var t = hf[n.type];
            (t & f && n.button === 0 && (this.pressed = !0), t & nt && n.which !== 1 && (t = u), this.pressed) && (t & u && (this.pressed = !1), this.callback(this.manager, t, {
                pointers: [n],
                changedPointers: [n],
                pointerType: yi,
                srcEvent: n
    ...
    o(wi, s, {
        handler: function(n) {
            ...
            (r & f && (n.button === 0 || c) ? i < 0 && (t.push(n), i = t.length - 1) : r & (u | e) && (o = !0), i < 0) || (t[i] = n, this.callback(this.manager, r, {
                pointers: t,
                changedPointers: [n],
                pointerType: s,
                srcEvent: n
    ...
    o(iu, s, {
        handler: function(n) {
            var i = yf[n.type],
                t;
            (i === f && (this.started = !0), this.started) && (t = bf.call(this, n, i), i & (u | e) && t[0].length - t[1].length == 0 && (this.started = !1), this.callback(this.manager, i, {
                pointers: t[0],
                changedPointers: t[1],
                pointerType: ot,
                srcEvent: n
    ...
    o(oi, c, {
        ...
        directionTest: function(n) {
            var i = this.options,
                ...
                f = n.deltaX,
                e = n.deltaY;
            return t & i.direction || (i.direction & l ? (t = f === 0 ? gt : f < 0 ? st : ht, r = f != this.pX, u = Math.abs(n.deltaX)) : (t = e === 0 ? gt : e < 0 ? ct : lt, r = e != this.pY, u = Math.abs(n.deltaY))), n.direction = t, r && u > i.threshold && t & i.direction
        },
        attrTest: function(n) {
    ...
    o(tr, w, {
        ...
        process: function(n) {
            ...
            else if (n.eventType & f) this.reset(), this._timer = ci(function() {
                this.state = p;
                this.tryEmit()
            }, t.time, this);
    ...
    o(rr, c, {
        ...
        attrTest: function(n) {
            var t = this.options.direction,
                i;
            return t & (l | tt) ? i = n.overallVelocity : t & l ? i = n.overallVelocityX : t & tt && (i = n.overallVelocityY), this._super.attrTest.call(this, n) && t & n.offsetDirection && n.distance > this.options.threshold && n.maxPointers == this.options.pointers && d(i) > this.options.velocity && n.eventType & u
        },
        emit: function(n) {
    ...
    o(si, w, {
        ...
        process: function(n) {
            ...
            if (s && c && o) {
                ...
                if (i = this.pTime ? n.timeStamp - this.pTime < t.interval : !0, r = !this.pCenter || ti(this.pCenter, n.center) < t.posThreshold, this.pTime = n.timeStamp, this.pCenter = n.center, r && i ? this.count += 1 : this.count = 1, this._input = n, e = this.count % t.taps, e === 0) return this.hasRequireFailures() ? (this._timer = ci(function() {
                    this.state = p;
                    this.tryEmit()
                }, t.interval, this), h) : p
            }
        ...
        failTimeout: function() {
            return this._timer = ci(function() {
                this.state = a
    ...
    fr.prototype = {
        ...
        recognize: function(n) {
            var r = this.session,
                i, f, t, u;
            if (!r.stopped)
                for (this.touchAction.preventDefaults(n), f = this.recognizers, t = r.curRecognizer, (!t || t && t.state & p) && (t = r.curRecognizer = null), u = 0; u < f.length;) i = f[u], r.stopped !== ur && (!t || i == t || i.canRecognizeWith(t)) ? i.recognize(n) : i.reset(), !t && i.state & (h | et | k) && (t = r.curRecognizer = i), u++
        },
        get: function(n) {
            var i, t;
    ...
    typeof define == "function" && define.amd ? define(function() {
        return b
    }) : typeof module != "undefined" && module.exports ? module.exports = b : n[i] = b
})(window, document, "Hammer"),
function(n) {
    "use strict";
    gi3dDebug("_global.js was loaded");
    n("html").removeClass("no-js").addClass("js");
    typeof gi3d_debug_mode != "undefined" && window.gi3d_debug_mode === !0 && n("html").addClass("debug");
    n("#debug-toggle").click(function() {
        window.gi3d_debug_mode = !window.gi3d_debug_mode;
        window.gi3d_debug_mode === !0 ? n("html").addClass("debug") : n("html").removeClass("debug")
    })
}(jQuery),
function(n, t) {
    "use strict";
    ...
    n(document).on("gi3d-card-ready", function(i) {
        function w(t) {
            var u, l, f, i;
            if (d(), t.type === "panstart" ? (c = e, e = 0, h = 0) : c = 0, o.hasClass("layout--portrait") || o.hasClass("layout--square")) u = o[0].clientWidth - 50, l = Math.max(Math.floor(u / s), 1), f = t.deltaX;
            else if (o.hasClass("layout--landscape")) u = o[0].clientHeight - 50, l = Math.max(Math.floor(u / s), 1), f = t.deltaY;
            else {
                gi3dDebug("😢 could not determine card type.");
                return
            }
            if (i = Math.floor(f / -l * nt), h !== i) {
                if (r = c + e + i - h, r = r < 1 ? 1 : r, r = r > s ? s : r, e !== r) e = r, h = i;
                else return;
                gi3dDebug(t.type, "deltaSize", f, "deltaStep", i, "oldDeltaStep", h, "initFrame", c, "oldFrame", e, "currentFrame", r);
                window.requestAnimationFrame(function() {
                    n(".card").removeClass(removeAllFrameClasses).addClass("frame-" + r)
                })
            }
        }
        ...
        function b() {
            var n = 5;
            if (p) {
                gi3dDebug("Hammer.Tap callback ignored because we are currently tweening");
                return
            }
            if (r >= u[2] - n) {
        ...
        function y(t, i) {
            ...
            k = setInterval(function() {
                p = !0;
                f === "increasing" && r >= t || f === "decreasing" && r <= t ? d() : (f === "increasing" && r >= t - u || f === "decreasing" && r <= t + u) && (u = 1);
                window.requestAnimationFrame(function() {
                    n(".card").removeClass(removeAllFrameClasses).addClass("frame-" + r);
                    e = r;
        ...
        var s = Number(window.getComputedStyle(document.querySelector(".layout"), "::after").getPropertyValue("content").replace(/"/g, "").replace(/'/g, "").split("||")[0]),
            f = window.getComputedStyle(document.querySelector(".layout"), "::after").getPropertyValue("content").replace(/"/g, "").replace(/'/g, "").split("||")[1].split("|"),
            u = [Number(f[0]), Number(f[0]) + Number(f[1]), Number(f[0]) + Number(f[1]) + Number(f[2]), ];
